...
var storage = multer.diskStorage({
    ...
    filename: function (req, file, cb) {
		...
		file.originalname=timestamp+'-'+file.originalname;
...
var uploadSingleHandler = function(req, res, next){
	var uploadObj = upload.single('avatar');
...
module.exports = {
	register: function(app){
		...
		//单位件上传   
		//注意上传界面中的 <input type="file" name="avatar" enctype="multipart/form-data"/>中的name必须是下面代码中指定的名称  
